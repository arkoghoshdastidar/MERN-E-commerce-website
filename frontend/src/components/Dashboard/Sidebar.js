...
import { MdOutlineReviews, MdOutlineCreate } from 'react-icons/md';
...
const Sidebar = () => {
    ...
    return (
        <div className={styles['sidebar']}>
            ...
            <div onClick={() => navigate('/admin/reviews')} className={styles['link']}><span><MdOutlineReviews /></span>Reviews</div>
        </div>
    )
}
